...
const TopButton = styled.button`
  ...
  &:active{
    background-color: ${(props) =>
            props.type === "filled" ? "#3e3e3e" : "#e9f5f5"};
  }
`;
        ...
        <Container>
            ...
            <Wrapper>
                ...
                <Top>
                    ...
                    <TopTexts>
                        <TopText>購物清單(2)</TopText>
                        <TopText>願望清單 (0)</TopText>
                    </TopTexts>
                    <TopButton type="filled">立即結賬</TopButton>
                </Top>
                <Bottom>
                    <Info>
                        <Product>
                    ...
                    <Summary>
                        <SummaryTitle>訂單匯總</SummaryTitle>
                        <SummaryItem>
                            <SummaryItemText>小計</SummaryItemText>
                            <SummaryItemPrice>￥ 800</SummaryItemPrice>
                        </SummaryItem>
                        <SummaryItem>
                            <SummaryItemText>預估運費</SummaryItemText>
                            <SummaryItemPrice>￥ 59.0</SummaryItemPrice>
                        </SummaryItem>
                        <SummaryItem>
                            <SummaryItemText>運輸折扣</SummaryItemText>
                            <SummaryItemPrice>￥ -59.0</SummaryItemPrice>
                        </SummaryItem>
                        <SummaryItem type="total">
                            <SummaryItemText>合計</SummaryItemText>
                            <SummaryItemPrice>￥ 800</SummaryItemPrice>
                        </SummaryItem>
                        <Button>立即結賬</Button>
                    </Summary>
